...
async function processImageIdentifiers(page, outputDir, n) {
    ...
    for (let i = 0; i < limitedUrls.length; i++) {
        ...
        try {
            ...
            await new Promise(resolve => setTimeout(resolve, 1000)); // Delay of 1 second between downloads
        } catch (error) {
...
scrapeImages('fingernail', 5); // Change 5 to any number of images you want to scrape
